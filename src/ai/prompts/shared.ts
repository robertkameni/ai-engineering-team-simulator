...
export function buildDiscussionDepthRules(
  ...
  const wordRange = style === "compact" ? "120–220" : "180–250";
  return `
...
- Target roughly **${wordRange} words** on a standard turn (shorter only when answering a [REJECT] correction). Hard ceiling: never exceed 250 words unless you are architect/backend (400-word ceiling). Include concrete metrics, library names, interfaces, failure modes, and acceptance criteria — not high-level platitudes.
