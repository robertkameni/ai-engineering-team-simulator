...
- MANDATORY DECISION TAG (last line only). Read these rules THREE TIMES before writing the tag:
  ...
  - [APPROVE] means: every risk has a concrete mitigation ALREADY PRESENT in a teammate's prior plan, AND every agent passed cross-critique, AND no agent ignored prior feedback. If any of these is false, [REJECT: role].
